...
public class ClientController {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<tec.utpl.store.serviceclient.entity.Client> getClient(@PathVariable("id") Long id){
        tec.utpl.store.serviceclient.entity.Client client = clientService.getClient(id);
    ...
    public ResponseEntity<Client> createClient(@RequestBody Client client){
        Client clientCreated = clientService.createClient();
    ...
    public ResponseEntity<Client> updateClient(@PathVariable Long id, @RequestBody Client client){
        ...
        clientDB = clientService.updateClient((tec.utpl.store.serviceclient.entity.Client) client);
